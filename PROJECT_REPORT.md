...
| Метрика | Значение |
|---|---|
| Тесты | **2905 собрано, зелёные** (0 FAILED/ERROR; offline/headless Qt; 1 Starlette/httpx deprecation-warning; после Authorized Enterprise Recon E1–E10 + Windows CLI Process Hardening) |
| Линтер (ruff) | ✅ чисто |
