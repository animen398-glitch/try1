...
| Метрика | Значение |
|---|---|
| Тесты | **2603 собрано, зелёные** (0 FAILED/ERROR; offline/headless Qt; 1 Starlette/httpx deprecation-warning; после DEV_PLAN WS1–WS6 + пост-план опции) |
| Линтер (ruff) | ✅ чисто |
