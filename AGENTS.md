...
tests/                  # pytest-набор (~2866 тестов, offline/headless)
...
**Тестовый ориентир:**
- `PROJECT_REPORT.md` указывает актуальный масштаб набора; на 2026-07-03 (после Authorized Enterprise Recon E1–E10 + increment-2 depth E3-2/E4-2/E5-2/E7-2 + E5-2 findings-fold + E4-2 web parity + dashboard button) — 2866 offline/headless теста (зелёные, 1 Starlette/httpx warning); GUI — 29 вкладок.
