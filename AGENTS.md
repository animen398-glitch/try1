...
**Последние важные изменения на 2026-06-30 (Gated Tool-Run Ingestion):**
...
**Тестовый ориентир:**
- `PROJECT_REPORT.md` указывает актуальный масштаб набора; на 2026-06-30 (после Gated Tool-Run Ingestion) — 2310 offline/headless тестов (зелёные, 1 Starlette/httpx warning).
