...
**Последние важные изменения на 2026-06-30 (Tool-Run Report Renderer):**
...
**Тестовый ориентир:**
- `PROJECT_REPORT.md` указывает актуальный масштаб набора; на 2026-06-30 (после Tool-Run Report Renderer) — 2305 offline/headless тестов (зелёные, 1 Starlette/httpx warning).
