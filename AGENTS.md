...
**Последние важные изменения на 2026-06-29 (Mission Center M6 — creation UI):**
...
**Тестовый ориентир:**
- `PROJECT_REPORT.md` указывает актуальный масштаб набора; на 2026-06-29 (после Mission Center M6) — 2220 offline/headless тестов (зелёные, 1 Starlette/httpx warning).
