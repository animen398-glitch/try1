...
**Тестовый ориентир:**
- `PROJECT_REPORT.md` указывает актуальный масштаб набора; на 2026-07-02 (после DEV_PLAN остаток WS6 + RapidDNS) — 2593 offline/headless теста (зелёные, 1 Starlette/httpx warning; junit-xml подтверждает 2593); GUI — 29 вкладок.
