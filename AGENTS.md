...
**Последние важные изменения на 2026-06-29 (Mission Center M3 — read/parity surfaces):**
...
**Тестовый ориентир:**
- `PROJECT_REPORT.md` указывает актуальный масштаб набора; на 2026-06-29 (после Mission Center M3) — 2200 offline/headless тестов (зелёные, 1 Starlette/httpx warning).
