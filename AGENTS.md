...
**Последние важные изменения на 2026-06-30 (Tool-Evidence: header + cookie extractors):**
...
**Тестовый ориентир:**
- `PROJECT_REPORT.md` указывает актуальный масштаб набора; на 2026-06-30 (после Tool-Evidence header+cookie extractors) — 2400 offline/headless тестов (зелёные, 1 Starlette/httpx warning; collect-only подтверждает 2400).
