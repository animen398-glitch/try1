...
**Последние важные изменения на 2026-06-29 (Mission Center M5 — report):**
...
**Тестовый ориентир:**
- `PROJECT_REPORT.md` указывает актуальный масштаб набора; на 2026-06-29 (после Mission Center M5) — 2216 offline/headless тестов (зелёные, 1 Starlette/httpx warning).
