...
**Тестовый ориентир:**
- `PROJECT_REPORT.md` указывает актуальный масштаб набора; на 2026-07-02 (после DEV_PLAN WS4 — Slack-канал алертинга) — 2570 offline/headless теста (зелёные, 1 Starlette/httpx warning; junit-xml подтверждает 2570); GUI — 29 вкладок.
