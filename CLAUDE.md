...
**Последние важные изменения на 2026-07-01 (GUI pagination: Dashboard/Intelligence/Accuracy):**
...
**Тестовый ориентир:**
- `PROJECT_REPORT.md` указывает актуальный масштаб набора; на 2026-07-01 (после GUI pagination Dashboard/Intelligence/Accuracy) — 2409 offline/headless тестов (зелёные, 1 Starlette/httpx warning; collect-only подтверждает 2409).
