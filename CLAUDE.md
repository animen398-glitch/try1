...
**Последние важные изменения на 2026-06-30 (GUI Table Pagination):**
...
**Тестовый ориентир:**
- `PROJECT_REPORT.md` указывает актуальный масштаб набора; на 2026-06-30 (после GUI Table Pagination) — 2368 offline/headless тестов (зелёные, 1 Starlette/httpx warning; collect-only подтверждает 2368).
