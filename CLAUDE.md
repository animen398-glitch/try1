...
**Тестовый ориентир:**
- `PROJECT_REPORT.md` указывает актуальный масштаб набора; на 2026-06-28 (после Mission Center M1) — 2162 offline/headless теста (зелёные, 1 Starlette/httpx warning).
