...
**Тестовый ориентир:**
- `PROJECT_REPORT.md` указывает актуальный масштаб набора; на 2026-07-01 (после dedup finding-render) — 2496 offline/headless теста (зелёные, 1 Starlette/httpx warning; collect-only подтверждает 2496); GUI — 31 вкладка.
