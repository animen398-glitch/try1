...
**Последние важные изменения на 2026-06-30 (Scan Retention & Backup):**
...
**Тестовый ориентир:**
- `PROJECT_REPORT.md` указывает актуальный масштаб набора; на 2026-06-30 (после Scan Retention & Backup) — 2361 offline/headless тест (зелёные, 1 Starlette/httpx warning; collect-only подтверждает 2361).
