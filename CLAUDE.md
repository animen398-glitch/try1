...
**Последние важные изменения на 2026-06-30 (Captured-Scan → Tool-Evidence Bridge):**
...
**Тестовый ориентир:**
- `PROJECT_REPORT.md` указывает актуальный масштаб набора; на 2026-06-30 (после Captured-Scan → Tool-Evidence Bridge) — 2389 offline/headless тестов (зелёные, 1 Starlette/httpx warning; collect-only подтверждает 2389).
