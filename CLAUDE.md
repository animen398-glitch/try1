...
**Последние важные изменения на 2026-06-30 (Tool Adapter Contract Foundation):**
...
**Тестовый ориентир:**
- `PROJECT_REPORT.md` указывает актуальный масштаб набора; на 2026-06-30 (после Tool Adapter Contract Foundation) — 2275 offline/headless тестов (зелёные, 1 Starlette/httpx warning).
