...
**Тестовый ориентир:**
- `PROJECT_REPORT.md` указывает актуальный масштаб набора; на 2026-06-29 (после Mission Center M15) — 2266 offline/headless тестов (зелёные, 1 Starlette/httpx warning).
