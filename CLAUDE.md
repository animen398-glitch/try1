...
**Последние важные изменения на 2026-06-30 (Tool→Canonical Finding/Asset Bridge):**
...
**Тестовый ориентир:**
- `PROJECT_REPORT.md` указывает актуальный масштаб набора; на 2026-06-30 (после Tool→Canonical Finding/Asset Bridge) — 2300 offline/headless тестов (зелёные, 1 Starlette/httpx warning).
