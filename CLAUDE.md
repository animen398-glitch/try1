...
**Последние важные изменения на 2026-07-01 (e2e / GUI-interaction tests):**
...
**Тестовый ориентир:**
- `PROJECT_REPORT.md` указывает актуальный масштаб набора; на 2026-07-01 (после e2e/GUI-interaction tests) — 2406 offline/headless тестов (зелёные, 1 Starlette/httpx warning; collect-only подтверждает 2406).
