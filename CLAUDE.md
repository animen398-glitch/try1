...
**Тестовый ориентир:**
- `PROJECT_REPORT.md` указывает актуальный масштаб набора; на 2026-07-02 (после DEV_PLAN WS5 инкремент 1 — нативные пассивные источники субдоменов) — 2573 offline/headless теста (зелёные, 1 Starlette/httpx warning; junit-xml подтверждает 2573); GUI — 29 вкладок.
