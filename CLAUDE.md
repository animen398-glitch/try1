...
**Последние важные изменения на 2026-06-30 (Web Console Auth & Safe Bind):**
...
**Тестовый ориентир:**
- `PROJECT_REPORT.md` указывает актуальный масштаб набора; на 2026-06-30 (после Web Console Auth & Safe Bind) — 2342 offline/headless теста (зелёные, 1 Starlette/httpx warning).
