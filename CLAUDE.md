...
**Тестовый ориентир:**
- `PROJECT_REPORT.md` указывает актуальный масштаб набора; на 2026-07-02 (после DEV_PLAN WS3 — конкурентный DAG-движок сканирования) — 2566 offline/headless теста (зелёные, 1 Starlette/httpx warning; junit-xml подтверждает 2566); GUI — 29 вкладок.
