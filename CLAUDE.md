...
**Последние важные изменения на 2026-06-30 (Tool-Run Orchestrator + surfaces):**
...
**Тестовый ориентир:**
- `PROJECT_REPORT.md` указывает актуальный масштаб набора; на 2026-06-30 (после Tool-Run Orchestrator + surfaces) — 2334 offline/headless теста (зелёные, 1 Starlette/httpx warning; collect-only подтверждает 2334).
