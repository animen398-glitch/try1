...
**Последние важные изменения на 2026-06-30 (Per-Tool Offline Parsers):**
...
**Тестовый ориентир:**
- `PROJECT_REPORT.md` указывает актуальный масштаб набора; на 2026-06-30 (после Per-Tool Offline Parsers) — 2282 offline/headless тестов (зелёные, 1 Starlette/httpx warning).
