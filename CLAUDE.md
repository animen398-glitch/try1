...
**Последние важные изменения на 2026-06-30 (Interactive Attack-Path Graph):**
...
**Тестовый ориентир:**
- `PROJECT_REPORT.md` указывает актуальный масштаб набора; на 2026-06-30 (после Interactive Attack-Path Graph) — 2375 offline/headless тестов (зелёные, 1 Starlette/httpx warning; collect-only подтверждает 2375).
