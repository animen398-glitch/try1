...
**Последние важные изменения на 2026-07-01 (Engagement & ROE Foundation — backend F1–F4):**
...
**Тестовый ориентир:**
- `PROJECT_REPORT.md` указывает актуальный масштаб набора; на 2026-07-01 (после Engagement & ROE Foundation backend F1–F4) — 2453 offline/headless теста (зелёные, 1 Starlette/httpx warning; collect-only подтверждает 2453).
