...
Проприетарная — все права защищены. Использование, копирование, изменение и
распространение возможны только по отдельному письменному соглашению с
правообладателем. Полный текст — в [`LICENSE`](LICENSE).

Назначение неизменно: **только авторизованное тестирование безопасности,
исследования и обучение** — против активов, которыми вы владеете или на проверку
которых у вас есть явное письменное разрешение.

Сторонние open-source компоненты остаются под своими лицензиями (LGPL-3.0 /
Apache-2.0 / MIT / BSD-3-Clause) — см. [`THIRD_PARTY_NOTICES.md`](THIRD_PARTY_NOTICES.md)
и каталог [`licenses/`](licenses/).
